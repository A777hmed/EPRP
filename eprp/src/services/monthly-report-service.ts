...
export interface MonthlyReportService {
  ...
  update(id: string, input: Partial<Pick<MonthlyReport, "executiveSummary" | "plannedProgress" | "actualProgress" | "hseStatus" | "qualityStatus" | "overallProgressStatus" | "preparedByContactId">> & { reportNumber?: string }): Promise<MonthlyReport>;
