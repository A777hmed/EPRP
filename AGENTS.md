...
```text
.                            ← you are here; this file is the canonical AGENTS.md
├── AGENTS.md
...
i need to connect to Claude code, i need to perform progress report platform, so i need yo to help me to give Claude code the best prompt to perform the platform.
